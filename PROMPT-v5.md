...
- New... (<kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>N</kbd>)
- Open... (<kbd>Ctrl</kbd>+<kbd>O</kbd>)
- Set music...
- Set background...
- Save (<kbd>Ctrl</kbd>+<kbd>S</kbd>)
- Save as level file... (<kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>S</kbd>)
...
The difficulty color automatically changes to a preset color if difficulty name is changed to one of "Easy", "Normal", "Hard", "Master", and "Special".
